...
## Decisão #35 — Runtime state por-processo via state file + heartbeat (substitui inferência por log no painel)
...
## Decisão #37 — Observabilidade enterprise via OpenTelemetry (Fase 4 da issue #303)
