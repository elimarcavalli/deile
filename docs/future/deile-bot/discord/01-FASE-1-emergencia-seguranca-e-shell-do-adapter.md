...
- Smoke local manual: `python3 -m deile_bot.cli run --provider discord` com `.env` contendo `DISCORD_TOKEN` real → bot conecta, `/help` responde, `/ping` responde.
...
| AC-3 | `pytest deile_bot/providers/discord/tests/ -v` passa |
