...
Tool especializada que o agente DEILE pode invocar para responder a uma story do próprio Page. Argumentos: `story_id`, `text`. Vive em `deilebot/providers/meta/instagram/tools/`.
