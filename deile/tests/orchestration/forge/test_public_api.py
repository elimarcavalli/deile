...
def test_forge_public_api():
    expected = {
        ...
        "ForgeCliNotFound", "ForgeCommandError", "GhCommandError",
        "MergeBlocked", "MergeBlockedByPipeline",
        "IssueRef", "PrRef", "MrRef", "CommentRef", "MentionTrigger",
        "compute_batch_id_for_number",
        "build_forge", "build_forge_config", "detect_forge_kind",
        "declared_hosts", "discover_cli",
        "parse_forge_url", "find_first_pr_url", "find_last_pr_url",
