...
class TestBuildInvestigationBrief:
    ...
    def test_multiple_anomalies(self):
        anomalies = [
            {"pattern_name": "error_rate_spike", "severity": "warning",
             "pod_name": "pod1", "count": 50},
            {"pattern_name": "crash_loop", "severity": "critical",
             "pod_name": "pod2", "count": 5},
        ]
        brief = _build_investigation_brief(anomalies)
...
class TestDispatchAnomalies:
    ...
    def test_no_token_returns_none(self, monkeypatch):
        ...
        result = dispatch_anomalies([{"pattern_name": "test", "severity": "info",
                                       "pod_name": "p", "count": 1}])
        assert result is None
