...
def test_parser_emits_harvested_session(audit, jc, tmp_path):
    ...
    ledger.write_text(
        json.dumps(
            {
                "v": 1,
                "session_id": "sess-harvested-1",
                "task_id": "aaaaaaaaaaaa0001",
                "models": models,
    ...
    harvested = [
        s for s in sessions if s.get("session_file") == "sess-harvested-1.jsonl"
    ]
    ...
    expected = jc.cost_of_model(
        models["claude-opus-4-5-20260101"], "claude-opus-4-5-20260101"
    )
...
def test_parser_reads_rich_v2_detail(audit, tmp_path):
    ...
    ledger.write_text(
        json.dumps(
            {
                "v": 2,
                "session_id": "sess-rich-1",
                "task_id": "cccccccccccc0003",
                "models": {
                    "claude-opus-4-5-20260101": {
                        "in": 100,
                        "out": 50,
                ...
                "last_ts": "2026-04-01T09:05:00.000Z",
                "assistant_rounds": 2,
                "harvested_at": 1_790_000_000.0,
                "source_mtime": 1_780_500_000.0,
                "tools": {"Read": 3, "Edit": 1},
                "user_msgs": 4,
                "tool_calls": 4,
                "cwd": "/home/claude/work/x/repo",
                "git_branch": "auto/issue-9",
                "version": "2.1.158",
                ...
                "meta_model": "anthropic:claude-opus-4-5",
