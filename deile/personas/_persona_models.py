"""
Camada de modelos de dados de persona — enums, dataclasses e schema Pydantic.
Módulo-folha: importa apenas stdlib + pydantic, zero imports de módulos DEILE.
Extraído de base.py para separar modelos de dados das ABCs (BasePersona/BaseAutonomousPersona).
"""
