"""Adapter for the deilebot daemon control-plane (the flecha reversa).

The DEILE CLI consumes the deilebot daemon's local HTTP API to send
...
`BOT_CLIENT_AVAILABLE` is False when the optional `deilebot`
