...
"""
    ...
    def _create_error_result(self, error_message: str, **metadata) -> ParseResult:
        """Helper para criar resultado de erro"""
        return ParseResult(
            status=ParseStatus.FAILED, error_message=error_message, metadata=metadata
        )
...
class RegexParser(Parser):
    ...
    def can_parse(self, input_text: str) -> bool:
        ...
        return any(pattern.search(input_text) for pattern in self._compiled_patterns)
